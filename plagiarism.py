...
def select_image():
    ...
    dataset_folder = r"C:\\Users\\VIDYA\\Desktop\\Image plagiarism detection\\seaAnimalsdataset"
    highest_similarity = compare_with_dataset(uploaded_image_path, dataset_folder)

    if highest_similarity >= 100:
        messagebox.showinfo("Result", "The image is fully plagiarized!")
    elif highest_similarity >= 80:
        messagebox.showinfo("Result", f"The image is partially plagiarized.\nSimilarity Percentage: {highest_similarity:.2f}%")
    else:
        messagebox.showinfo("Result", "The image is not plagiarized!")
